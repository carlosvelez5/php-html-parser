...
class Dom {
    ...
    public function __set( $name, $value )
	{
		// Inner - Outer
        switch ( $name ) {
            case 'outerHtml': return $this->root->outerHtml = $value;
            case 'innerHtml': return $this->root->innerHtml = $value;
        }
	...
	{
		if( method_exists( $this->root, $method ) )
		{
